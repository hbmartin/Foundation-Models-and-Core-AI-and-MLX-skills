...
[frozen Noema research note](../../../notes/repos/noema-ios.md) reaches the same shape with a `for`
...
- **~576 tokens per image.** Historical source: the shipping community app preserved in the
  [frozen Noema research note](../../../notes/repos/noema-ios.md), which hardcodes
...
**Community** — [frozen Noema 3.5 snapshot](../../../notes/repos/noema-ios.md) (a shipping multi-backend app: the `for`-loop prompt builder,
