...
- The generated arguments include **`searchTerms: [String]`**. ✅ **VERIFIED** — same note. This is
  ...
  **83,494-character** value is preserved in
  ...
  [`probes/artifacts/spotlight-tool-schema-device-os27.0.0-24A5408d-xcode-27A5237l.txt`](../../../probes/artifacts/spotlight-tool-schema-device-os27.0.0-24A5408d-xcode-27A5237l.txt).
