...
[Part 4](../../part-04-beyond-the-built-in-model/) and Part 2's Spotlight RAG guide; the only thing
...
- **[Part 4](../../part-04-beyond-the-built-in-model/)** — putting an MLX model behind
...
- **[Part 11](../../part-11-metal-and-tensorops/)** — why `head_dim ∈ {72, 96, 192, 256, 512}`
  silently falls back to a composed SDPA, and what padding to a supported dim costs.
- **[Part 1](../../part-01-orientation-and-gating/)** — the backend decision table, and the
