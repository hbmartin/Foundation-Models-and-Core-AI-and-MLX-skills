...
- **[The silent-failure index](SILENT-FAILURES.md)** — every warning callout in the series (1,790,
  of which 1,428 describe a concrete silent failure), in one page, sorted by the symptom you
