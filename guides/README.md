...
**[Build an AI feature in a Swift app](part-02-foundation-models-everyday-api/README.md)**
...
**[Convert a PyTorch model for on-device use](part-08-coreai-pytorch-conversion/README.md)**
...
**[Work in Python with MLX](part-12-mlx-python/README.md)**
...
**[Migrate a pre-iOS-27 app](part-17-migration-from-pre-ios-27/README.md)**
...
- **[The silent-failure index](SILENT-FAILURES.md)** — every warning callout in the series (1,777,
  of which 1,415 describe a concrete silent failure), in one page, sorted by the symptom you
