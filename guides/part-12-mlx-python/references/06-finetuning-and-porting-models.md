...
[Part 6](../../part-06-evaluations/references/02-model-judges-and-alignment.md). If you are
...
> benchmark at all. See [Part 15](../../part-15-shipping-and-operating/references/02-memory-thermals-and-honest-benchmarking.md)
...
> cross-stack bridge in the sense [Part 14](../../part-14-bridges-between-stacks/) uses the word,
...
- **Benchmarking:** `mlx-benchmark` (MLX ops vs MPS vs CUDA) — a candidate cross-check for
  Part 15's numbers.
- **Speech**, adjacent to [Part 16.1](../../part-16-adjacent-capabilities/references/01-speech-analyzer-end-to-end.md):
