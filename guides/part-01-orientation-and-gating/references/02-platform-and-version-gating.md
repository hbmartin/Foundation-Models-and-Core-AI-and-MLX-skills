...
> [Part 17.1](../../part-17-migration-from-pre-ios-27/references/01-what-changed-checklist.md).
...
[Part 17.3](../../part-17-migration-from-pre-ios-27/references/03-error-taxonomy-migration.md).
...
> [Part 7.2](../../part-07-coreai-swift-runtime/references/02-specialization-caching-and-aot.md).
...
> both tiers; see [Part 6](../../part-06-evaluations/).
...
> [Part 12.2](../../part-12-mlx-python/references/02-numerics-hardware-gating-and-custom-kernels.md).
...
- **The full error and refusal taxonomy:** [Part 2](../../part-02-foundation-models-everyday-api/)
- **PCC in practice — reasoning levels, quota UX:** [Part 4](../../part-04-beyond-the-built-in-model/)
