...
🧑‍💻 **COMMUNITY — [frozen Noema 3.5 snapshot](../../../notes/repos/noema-ios.md)** (Noema 3.5, MIT). This is a shipping multi-backend
...
**COMMUNITY — [frozen Noema 3.5 snapshot](../../../notes/repos/noema-ios.md)**, ✅ VERIFIED from the retained research note,
...
🧑‍💻 **COMMUNITY — [frozen Noema 3.5 snapshot](../../../notes/repos/noema-ios.md)** hit this and left a comment about it. ✅ VERIFIED from
...
- **A reconciliation of the retired 4096-vs-8192 context-window conflict.** Apple's TN3193 says
  ...
  [Part 3](../../part-03-context-profiles-agentic/) owns the resolution. Read `contextSize`.
...
**Community, attributed:** [frozen Noema 3.5 snapshot](../../../notes/repos/noema-ios.md) (Noema 3.5, MIT) — the
