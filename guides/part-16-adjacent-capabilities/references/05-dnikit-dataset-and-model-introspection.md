...
go read [Part 9](../../part-09-coreai-compression-numerics/). Nothing later in the series depends
on anything here.
...
|---|---|---|
| Duplicate clusters spanning train/test | Your split; your reported accuracy | Before anything. Also invalidates [Part 6](../../part-06-evaluations/) baselines. |
...
| `PFARecipe.recommended_output_count` ≪ `original_output_count` | Model definition → retrain | Then [Part 8](../../part-08-coreai-pytorch-conversion/), then [Part 9](../../part-09-coreai-compression-numerics/). |
...
compression go to [Part 9](../../part-09-coreai-compression-numerics/) and
[Part 12 guide 03](../../part-12-mlx-python/references/03-quantization.md) instead.
...
[Part 8 — Core AI: converting from PyTorch](../../part-08-coreai-pytorch-conversion/). If it found
