...
| "I hardcoded 4096" | [3.1 §3](references/01-context-window-and-kv-cache.md#3-reading-the-budget-contextsize-and-the-4096-token-window) | TN3193 settles the figure at 4,096, now probe-confirmed on simulator and iPhone 15 Pro / iOS build `24A5408d`; the 8192 report remains uncorroborated. Still read `contextSize` |
