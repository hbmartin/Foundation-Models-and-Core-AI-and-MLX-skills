...
[Part 6](../../part-06-evaluations/) — you cannot reason your way to the right prompt length.
...
[Part 5](../../part-05-prototyping-profiling-non-swift/). The one operational warning worth repeating:
...
> [`../../part-17-migration-from-pre-ios-27/references/03-error-taxonomy-migration.md`](../../part-17-migration-from-pre-ios-27/references/03-error-taxonomy-migration.md).
...
> feature**. Full treatment in [Part 4](../../part-04-beyond-the-built-in-model/).
...
Concretely, what you want from [Part 6](../../part-06-evaluations/) for this guide's material:
...
- **Writing an executor that actually reuses its cache** →
  [`../../part-04-beyond-the-built-in-model/references/04-executor-lifecycle-and-kv-reuse.md`](../../part-04-beyond-the-built-in-model/references/04-executor-lifecycle-and-kv-reuse.md)
- **Quantifying a context-engineering change** → [Part 6, Evaluations](../../part-06-evaluations/)
