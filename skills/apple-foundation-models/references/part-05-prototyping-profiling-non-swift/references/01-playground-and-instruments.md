...
- *Analyzing the runtime performance of your Foundation Models app* — direct Apple Markdown captured
  ...
  the [runtime-performance evidence note](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/notes/web/apple-foundation-models-runtime-performance-2026-09-22.md).
- *Optimizing key-value caching in language model sessions* — direct Apple Markdown captured on
  ...
  [evidence note](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/notes/web/apple-foundation-models-runtime-performance-2026-09-22.md)
