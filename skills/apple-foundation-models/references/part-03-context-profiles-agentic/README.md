...
|---|---|---|
| "I keep hitting `contextSizeExceeded`" | [3.1 §6–§7](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-03-context-profiles-agentic/references/01-context-window-and-kv-cache.md) | The four levers, Apple's documented recovery, and the 26.0-only rebuild path |
| "I hardcoded 4096" | [3.1 §3](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-03-context-profiles-agentic/references/01-context-window-and-kv-cache.md) | TN3193 settles the figure at 4,096 (probe-confirmed on the 27.0 simulator); an uncorroborated 8192 claim survives only for 27 hardware. Still read `contextSize` |
| "Time-to-first-token climbs turn over turn, prompt size flat" | [3.1 §8](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-03-context-profiles-agentic/references/01-context-window-and-kv-cache.md) | Something is invalidating your prefix. §8.10's expensive list is the checklist |
| "I need to know what a turn actually cost" | [3.1 §5](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-03-context-profiles-agentic/references/01-context-window-and-kv-cache.md) | `Usage`, `cachedTokenCount`, and the cache-hit-rate formula |
| "I'm choosing a model for a multi-turn chat" | [3.1 §10](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-03-context-profiles-agentic/references/01-context-window-and-kv-cache.md) | Linear-attention hybrids **cannot prefix-cache at all**. This outranks parameter count |
...
| "My profile never switches" | [3.2 §2, §6](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-03-context-profiles-agentic/references/02-dynamic-profiles-and-session-state.md) | The body is a projection; check what state you read versus what you mutate |
| "Where do I put state that a tool and a profile both need?" | [3.2 §11](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-03-context-profiles-agentic/references/02-dynamic-profiles-and-session-state.md) | `@SessionPropertyEntry` on `SessionPropertyValues`, read via `@SessionProperty(\.…)` |
| "Should I use `history` or `historyTransform`?" | [3.2 §12](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-03-context-profiles-agentic/references/02-dynamic-profiles-and-session-state.md) | Lossy-and-global versus lossless-and-per-profile. The most consequential choice in the API |
...
| "My summarisation modifier does nothing" | [3.3 §5–§6](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-03-context-profiles-agentic/references/03-skills-and-history-modifiers.md) | Every composed example Apple ships is arithmetically inert |
| "I want to load domain knowledge just-in-time" | [3.3 §11–§17](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-03-context-profiles-agentic/references/03-skills-and-history-modifiers.md) | `Skills`, and the one line of source that decides whether your KV cache survives |
| "One model should hand off to another" | [3.4 §2](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-03-context-profiles-agentic/references/04-agentic-orchestration.md) | Baton-pass — and what Apple's shipping sample does instead |
| "I want a specialist opinion without polluting the conversation" | [3.4 §3](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-03-context-profiles-agentic/references/04-agentic-orchestration.md) | Phone-a-friend: a child session with an isolated transcript |
| "`respond(to:)` never returns" | [3.4 §6](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-03-context-profiles-agentic/references/04-agentic-orchestration.md) | `.required` is an unbounded `while` loop. Apple documents exactly two exits |
| "The model wants to change the user's data" | [3.4 §7](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-03-context-profiles-agentic/references/04-agentic-orchestration.md) | Origami's propose/confirm pattern. The tool proposes; the app disposes |
| "Is a hop to PCC worth it?" | [3.4 §8](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-03-context-profiles-agentic/references/04-agentic-orchestration.md) | Routing economics, quota gates, and the backend constraint that kills `@Generable` |
| "How do I test that the handoff happened?" | [3.4 §10](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-03-context-profiles-agentic/references/04-agentic-orchestration.md) | Trajectory expectations — and why `disallowed` is the assertion people skip |
...
**Defer or skip:**
- **[3.3 §19](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-03-context-profiles-agentic/references/03-skills-and-history-modifiers.md)** (`ChatCompletionsLanguageModel`) is a pointer;
  the real treatment is [Part 4](../part-04-beyond-the-built-in-model/README.md).
- **[3.4 §10](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-03-context-profiles-agentic/references/04-agentic-orchestration.md)** (trajectory evaluation) is a preview of
...
- **[3.1 §9](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-03-context-profiles-agentic/references/01-context-window-and-kv-cache.md)** is provider-internals; skip unless you are
