...
|---|---|---|
| "I just need something smaller, today" | [9.1 §3](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/01-quantization.md) | `presets.w4()` / `w8()`, and the eleven fields each one silently sets |
| "My compressed model is bigger than the arithmetic says" | [9.1 §7.5](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/01-quantization.md) · [9.3 §2.7](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/03-numeric-formats-across-the-stack.md) | The block-divisibility silent skip. The single most common defect in this part |
| "My model won't `torch.export`" | [9.1 §8.4](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/01-quantization.md) | EAGER mode — and the non-obvious externalization reason for choosing it |
| "I need to quantize activations, not just weights" | [9.1 §8–§9](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/01-quantization.md) | GRAPH mode, observers, calibration, and the six ops whose qscheme is overridden behind your back |
| "Quality fell off a cliff below 8 bits" | [9.1 §10.2, §11, §13](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/01-quantization.md) → [9.2 §14–§15](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/02-palettization-pruning-and-joint.md) | The bit-width ladder, then QAT; then the SAM3 diagnosis and the sensitivity sweep that automates it |
| "I'm targeting iOS / the Neural Engine" | [9.2 §1.3, §5](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/02-palettization-pruning-and-joint.md) | Apple's exporter **refuses** to build a quantized iOS bundle. Palettization, grouped-channel, and the rank-5 ceiling |
| "I'm targeting the macOS GPU" | [9.3 §9.1](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/03-numeric-formats-across-the-stack.md) | int4 `symmetric_with_clipping`, per-block 32 — Apple's own preset, and why int8 buys bandwidth not arithmetic |
| "Should I prune?" | [9.2 §11.1, §11.8](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/02-palettization-pruning-and-joint.md) | Apple's own answer is "probably not", and the 🔴 GAP under it should decide it for you |
| "I want palettized weights *and* quantized activations" | [9.2 §13](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/02-palettization-pruning-and-joint.md) | Joint compression: mandatory ordering, mandatory `lut_qspec`, CoreAI backend only |
| "Which format can the hardware actually multiply?" | [9.3 §1.2](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/03-numeric-formats-across-the-stack.md) | The master matrix. Emit vs store vs compute, on one page |
| "Numbers are right; it's just slower than it should be" | [9.3 §7.1](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/03-numeric-formats-across-the-stack.md) | Eighteen crossings that silently degrade, with a detection method each |
| "How do I verify what I actually shipped?" | [9.3 §8](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/03-numeric-formats-across-the-stack.md) · [9.2 §16](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/02-palettization-pruning-and-joint.md) | Model viewer, `AIModelAsset.Summary`, Instruments — then Apple's PSNR acceptance gates |
| "I only have an `.aimodel`, no PyTorch model" | [9.1 §15](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/01-quantization.md) · [9.2 §12](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/02-palettization-pruning-and-joint.md) | Program-level passes. Apple's own docs call this the non-preferred path |
| "I have to ship to `ct.target.iOS26`" | [9.1 §16.2](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/01-quantization.md) · [9.3 §2.8](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/03-numeric-formats-across-the-stack.md) | The CoreML restriction matrix. It rejects loudly at `finalize()`, which is the good news |
| "I'm deploying an LLM and the KV cache is the budget" | [9.1 §12](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/01-quantization.md) | KV-cache quantization: graph mode only, in no session, with a correctness precondition nothing checks |
...
[9.2 §16](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/02-palettization-pruning-and-joint.md), Apple's PSNR gates, and wire a metric up
before your first `prepare()` — Apple's own compression skill refuses to run without one.

**Skippable outright.** [9.2 §11](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/02-palettization-pruning-and-joint.md) (pruning) unless
you have a training loop, a dataset and a verified hardware requirement — read §11.1 and §11.8 and
leave. [9.1 §16](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/01-quantization.md) and [9.3 §2.8](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/03-numeric-formats-across-the-stack.md)
unless you ship to `ct.target.iOS26`; [9.3 §6](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/03-numeric-formats-across-the-stack.md)
unless you also use MLX; [9.1 §12](https://github.com/hbmartin/Foundation-Models-and-Core-AI-and-MLX-skills/blob/main/guides/part-09-coreai-compression-numerics/references/01-quantization.md) unless you deploy an LLM.
